<div id="default-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
        <?php $count = 0; foreach ($items as $index => $item): ?>
            <button type="button" class="w-3 h-3 rounded-full" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="<?= $count++;?>"></button>
        <?php endforeach; ?>
    </div>
    <!-- Slider controls -->
